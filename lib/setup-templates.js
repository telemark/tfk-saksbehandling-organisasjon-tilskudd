...
module.exports = miss.through((chunk, encoding, callback) => {
  ...
  documentIn.title = `Søknad tilskudd`
  documentIn.offTitle = `Søknad tilskudd`

  documentOut.title = `Søknad tilskudd mottatt`
  documentOut.offTitle = `Søknad tilskudd mottatt`
